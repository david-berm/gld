...
The data covers a sample of urban and rural in all egyptian governorates (27 or 29). Each year the list of geographic locations below governorates changes to dismiss or include existent cities or new cities. From 2021, North Sinai governorate did not include on the survey. Below a summary of the changes that the user may encounter. 
